...
public class EditAccountActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(c!=null) {
            ...
            Toast.makeText(EditAccountActivity.this,u.getEmail(),Toast.LENGTH_SHORT).show();
        ...
        b1.setOnClickListener(
                new View.OnClickListener() {
                    public void onClick(View v) {
                        Toast.makeText(EditAccountActivity.this,"Nội dung chưa đc nhập",Toast.LENGTH_SHORT).show();
                    }
                }
        );
        b2.setOnClickListener(
                new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        Toast.makeText(EditAccountActivity.this,"Update thành công",Toast.LENGTH_SHORT).show();
        ...
        b3.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        Toast.makeText(EditAccountActivity.this,e3.getText().toString().trim(),Toast.LENGTH_SHORT).show();
